package cadastro_fornecedor_incluir
...
type ActionInput struct {
	...
	CodBanco            string `json:"CodBanco,omitempty"`            // *Código do banco.
	CodAgencia          string `json:"CodAgencia,omitempty"`          // *Código da agência bancária.
	...
	Numero              string `json:"Numero,omitempty"`              // *Número do endereço.
	...
	CodPessoaFavorecido string `json:"CodPessoaFavorecido,omitempty"` // Código da pessoa favorecida em pagamentos ao fornecedor.
	CodPessoaTitular    string `json:"CodPessoaTitular,omitempty"`    // Código da pessoa titular da empresa para fins previdenciários.
