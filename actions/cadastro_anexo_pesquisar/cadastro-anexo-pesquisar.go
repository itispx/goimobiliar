...
import (
	...
	"github.com/itispx/goimobiliar/anexo/cod_categoria"
	"github.com/itispx/goimobiliar/anexo/envia_site"
	"github.com/itispx/goimobiliar/anexo/tipo_anexo"
	"github.com/itispx/goimobiliar/anexo/tipo_origem"
...
type ActionInput struct {
	...
	TipoAnexo      tipo_anexo.TipoAnexo           `json:"TipoAnexo,omitempty"`      // Código do cadastro de anexo que indica o tipo dos arquivos.Deixe vazio para todos.
	TipoOrigem     tipo_origem.TipoOrigem         `json:"TipoOrigem"`               // *Código do cadastro de origem vinculado ao anexo.
	...
	CodCategoria   cod_categoria.CodCategoria     `json:"CodCategoria,omitempty"`   // Código da categoria do anexo.
	Extra          string                         `json:"Extra"`                    // *Campo para dados extras.
	EnviaSite      envia_site.EnviaSite           `json:"EnviaSite,omitempty"`      // Campo para filtrar por arquivos que são enviados para o site.
	OrdenarPor     ordenar_por.OrdenarPor         `json:"OrdenarPor,omitempty"`     // Ordem de exibição. Valor default é 'C'.
...
func handler(input *HandlerInput) (*HandlerOutput, error) {
	request := Request{
		Header: &RequestHeader{
			...
			Action:    "CADASTRO_ANEXO_PESQUISAR",
		},
		Body: &RequestBody{
			input.ActionInput,
		},
